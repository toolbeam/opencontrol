...
export function IconTag(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path fillRule="evenodd" d="M5.25 2.25a3 3 0 00-3 3v4.318a3 3 0 00.879 2.121l9.58 9.581c.92.92 2.39.92 3.31 0l4.908-4.908a2.25 2.25 0 000-3.312l-9.58-9.58a3 3 0 00-2.121-.879H5.25zM6.375 7.5a1.125 1.125 0 100-2.25 1.125 1.125 0 000 2.25z" clipRule="evenodd" />
    </svg>
  );
}
...
export function IconArrowSmallDown(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      ...
      <path fillRule="evenodd" d="M9 13.5a.75.75 0 01.75-.75h4.5a.75.75 0 010 1.5h-4.5A.75.75 0 019 13.5zM8.47 17.47a.75.75 0 011.06 0l2.5 2.5a.75.75 0 001.06 0l2.5-2.5a.75.75 0 111.06 1.06l-2.5 2.5a2.25 2.25 0 01-3.18 0l-2.5-2.5a.75.75 0 010-1.06z" clipRule="evenodd" />
    </svg>
  );
}
...
export function IconArrowSmallLeft(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path fillRule="evenodd" d="M20.25 12a.75.75 0 01-.75.75H4.5a.75.75 0 010-1.5h15a.75.75 0 01.75.75z" clipRule="evenodd" />
      <path fillRule="evenodd" d="M10.72 6.97a.75.75 0 011.06 0l3.75 3.75a.75.75 0 010 1.06l-3.75 3.75a.75.75 0 01-1.06-1.06l3.22-3.22-3.22-3.22a.75.75 0 010-1.06z" clipRule="evenodd" />
    </svg>
  );
}
...
export function IconArrowSmallRight(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path fillRule="evenodd" d="M3.75 12a.75.75 0 01.75-.75h15a.75.75 0 010 1.5H4.5a.75.75 0 01-.75-.75z" clipRule="evenodd" />
      <path fillRule="evenodd" d="M13.28 6.97a.75.75 0 00-1.06 0l-3.75 3.75a.75.75 0 000 1.06l3.75 3.75a.75.75 0 101.06-1.06l-3.22-3.22 3.22-3.22a.75.75 0 000-1.06z" clipRule="evenodd" />
    </svg>
  );
}
...
export function IconArrowSmallUp(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path fillRule="evenodd" d="M12 20.25a.75.75 0 01-.75-.75V9a.75.75 0 011.5 0v10.5a.75.75 0 01-.75.75z" clipRule="evenodd" />
      <path fillRule="evenodd" d="M9 10.5a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0v-4.5A.75.75 0 019 10.5zM8.47 4.97a.75.75 0 011.06 0l2.5 2.5a.75.75 0 01-1.06 1.06L8.5 6.06 6.03 8.53a.75.75 0 01-1.06-1.06l2.5-2.5a.75.75 0 011 0z" clipRule="evenodd" />
    </svg>
  );
}
...
export function IconArrowTopRightOnSquare(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path fillRule="evenodd" d="M15.75 2.25H21a.75.75 0 01.75.75v5.25a.75.75 0 01-1.5 0V4.81L8.03 17.03a.75.75 0 01-1.06-1.06L19.19 3.75h-3.44a.75.75 0 010-1.5zm-6.75 6a.75.75 0 01.75-.75h5.25a.75.75 0 010 1.5H10.5v9a.75.75 0 01-.75.75h-5.25a.75.75 0 01-.75-.75v-9c0-.414.336-.75.75-.75h5.25z" clipRule="evenodd" />
    </svg>
  );
}
...
export function IconArrowTrendingDown(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path fillRule="evenodd" d="M1.72 5.47a.75.75 0 011.06 0L9 11.69l3.756-3.756a.75.75 0 01.985-.066l7.5 6a.75.75 0 01-.93 1.176l-7.004-5.602-3.75 3.75a.75.75 0 01-1.06 0l-6.75-6.75a.75.75 0 010-1.06z" clipRule="evenodd" />
...
export function IconArrowTrendingUp(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path fillRule="evenodd" d="M15.22 6.268a.75.75 0 01.44-.44l5.25-2.25a.75.75 0 01.988.924l-2.25 5.25a.75.75 0 01-1.373-.012l-1.144-2.668-9.532 9.532a.75.75 0 01-1.06 0l-3.75-3.75a.75.75 0 011.06-1.06l3.22 3.22L15.22 6.268z" clipRule="evenodd" />
    </svg>
  );
}
